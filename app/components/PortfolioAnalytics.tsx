          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-purple-300">Nasihat cerdas dari asisten virtual Anda</p>
              </div>
            </div>
            <button
              onClick={handleAskAI}
              disabled={isAiLoading || filteredTransactions.length === 0}
              className="w-full md:w-auto px-5 py-2.5 bg-white/5 hover:bg-white/10 border border-purple-500/30 text-purple-300 text-sm font-semibold rounded-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2 relative overflow-hidden group"
            >
              {isAiLoading ? (
                <>
                  ...
                  <span className="ml-2 text-purple-200">Menganalisa Data...</span>
                </>
              ) : 'Minta Analisa'}
            </button>
          </div>
